  ...
  render(){
    return (
      <div className="fish-edit">
        ...
        <textarea type="text" name="desc" value={this.props.fish.desc} onChange={this.handleChange} placeholder="Name" />
        <input type="text" name="image" value={this.props.fish.image} onChange={this.handleChange} placeholder="Image" />
